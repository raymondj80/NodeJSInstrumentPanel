!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        ...
        var i = n.toHsl(),
          a = n.toHsv();
        return (
          0 === i.s && (a.h = i.h = e.h || (e.hsl && e.hsl.h) || t || 0),
          {
            hsl: i,
    ...
    function (e, t, n) {
      ...
      (f.options.__file = "src/components/common/EditableInput.vue"),
        (t.default = f.exports);
    },
    function (e, t) {
    ...
    function (e, t, n) {
      ...
      var s = n(113),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/common/Hue.vue"),
        (t.default = f.exports);
    },
    function (e, t) {
      e.exports = !0;
    ...
    function (e, t, n) {
      ...
      var s = n(127),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/common/Saturation.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      "use strict";
      ...
      var s = n(133),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/common/Alpha.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      "use strict";
      ...
      var s = n(132),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/common/Checkboard.vue"),
        (t.default = f.exports);
    },
    function (e, t) {
      var n = Math.ceil,
        ...
        methods: {
          isActive: function (e, t) {
            ...
            return (
              (1 === n.l && 1 === e.l) ||
              (0 === n.l && 0 === e.l) ||
              (Math.abs(n.l - e.l) < 0.01 && Math.abs(n.s - e.s) < 0.01)
            );
          },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, p, v, g, b) {
        ...
        if (
          (E &&
            (_ = u(E.call(new e()))) !== Object.prototype &&
            _.next &&
            (l(_, y, !0), r || "function" == typeof _[f] || a(_, f, h)),
          C &&
            S &&
            "values" !== S.name &&
            ((k = !0),
    ...
    function (e, t, n) {
      var r = n(4),
        ...
        c = function (e, t, n) {
          ...
          h && (n = t);
          for (l in n)
            ((u = !d && _ && void 0 !== _[l]) && s(x, l)) ||
              ((f = u ? _[l] : n[l]),
              (x[l] =
                h && "function" != typeof _[l]
                  ? n[l]
                  : g && u
                  ? o(f, r)
                  : b && _[l] == f
          ...
          handleChange: function (e, t) {
            ...
            if (n) {
              var r,
                ...
                s = a - o;
              (r = s < 0 ? 0 : s > i ? 1 : Math.round((100 * s) / i) / 100),
                this.colors.a !== r &&
                  this.$emit("change", {
                    h: this.colors.hsl.h,
                    s: this.colors.hsl.s,
      ...
      t.default = {
        ...
        computed: {
          hex: function () {
            var e = void 0;
            return (
              (e = this.colors.a < 1 ? this.colors.hex8 : this.colors.hex),
              e.replace("#", "")
            );
          },
    ...
    function (e, t, n) {
      ...
      t.default = {
        name: "Twitter",
        mixins: [s.default],
        components: { editableInput: o.default },
        props: {
    ...
    function (e, t, n) {
      ...
      var s = n(69),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Compact.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(63);
      ...
      !(function (i) {
        ...
        function c(e, t, n) {
          ...
          if (o == a) r = i = 0;
            ...
            var c = o - a;
            switch (((i = s > 0.5 ? c / (2 - o - a) : c / (o + a)), o)) {
              case e:
                r = (t - n) / c + (t < n ? 6 : 0);
                break;
              case t:
        ...
        function l(e, t, n) {
          ...
          return { r: 255 * i, g: 255 * o, b: 255 * a };
        }
        ...
        function m(e, t) {
          ...
          var n = o(e).toRgb();
          return (
            (n.r = q(0, V(255, n.r - G((-t / 100) * 255)))),
            (n.g = q(0, V(255, n.g - G((-t / 100) * 255)))),
            (n.b = q(0, V(255, n.b - G((-t / 100) * 255)))),
            o(n)
          );
        }
        ...
        function C(e) {
          ...
          return [
            o(e),
            o({ h: (n + 120) % 360, s: t.s, l: t.l }),
            o({ h: (n + 240) % 360, s: t.s, l: t.l }),
          ];
        }
        ...
        function k(e) {
          ...
          return [
            o(e),
            o({ h: (n + 90) % 360, s: t.s, l: t.l }),
            o({ h: (n + 180) % 360, s: t.s, l: t.l }),
            o({ h: (n + 270) % 360, s: t.s, l: t.l }),
          ];
        }
        ...
        function A(e, t) {
          t = t || 6;
          for (
            var n = o(e).toHsv(), r = n.h, i = n.s, a = n.v, s = [], c = 1 / t;
            t--;

          )
            s.push(o({ h: r, s: i, v: a })), (a = (a + c) % 1);
          return s;
        }
        ...
        function N(e) {
          ...
          return (n = J.rgb.exec(e))
            ...
            : (n = J.hex6.exec(e))
            ? { r: j(n[1]), g: j(n[2]), b: j(n[3]), format: t ? "name" : "hex" }
            : (n = J.hex4.exec(e))
            ? {
                r: j(n[1] + "" + n[1]),
                g: j(n[2] + "" + n[2]),
        ...
        (o.prototype = {
          ...
          getLuminance: function () {
            ...
            return (
              ...
              (t = s.g / 255),
              (n = s.b / 255),
              (r = e <= 0.03928 ? e / 12.92 : i.pow((e + 0.055) / 1.055, 2.4)),
              (o = t <= 0.03928 ? t / 12.92 : i.pow((t + 0.055) / 1.055, 2.4)),
          ...
          setAlpha: function (e) {
            return (
              (this._a = O(e)), (this._roundA = G(100 * this._a) / 100), this
            );
          },
          toHsv: function () {
          ...
          (o.mostReadable = function (e, t, n) {
            ...
            return o.isReadable(e, c, { level: a, size: s }) || !i
              ? c
    ...
    function (e, t, n) {
      ...
      var s = n(73),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Grayscale.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(72);
    ...
    function (e, t, n) {
      ...
      var s = n(77),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Material.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(76);
    ...
    function (e, t, n) {
      ...
      var r = n(4),
        ...
        Z = function (e) {
          ...
          return (
            !(this === $ && i(z, e) && !i(I, e)) &&
            (!(t || !i(this, e) || !i(z, e) || (i(this, B) && this[B][e])) || t)
          );
        },
        Q = function (e, t) {
          if (((e = w(e)), (t = y(t, !0)), e !== $ || !i(z, t) || i(I, t))) {
            var n = M(e, t);
            return (
              !n || !i(z, t) || (i(e, B) && e[B][t]) || (n.enumerable = !0), n
            );
          }
        },
        ee = function (e) {
      ...
      U ||
        ((P = function () {
          ...
          return o && V && q($, e, { configurable: !0, set: t }), X(e);
        }),
        ...
        (n(34).f = Z),
        (A.f = te),
        o && !n(14) && s($, "propertyIsEnumerable", Z, !0),
        (p.f = function (e) {
          return X(h(e));
        })),
      ...
      a(a.S + a.F * ae, "Object", {
        ...
        P.prototype[T] || n(7)(P.prototype, T, P.prototype.valueOf),
        f(P, "Symbol"),
        f(Math, "Math", !0),
        f(r.JSON, "JSON", !0);
    },
    ...
    function (e, t, n) {
      ...
      var s = n(119),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Swatches.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(117);
    ...
    function (e, t, n) {
      ...
      var s = n(134),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Photoshop.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(122);
    ...
    function (e, t, n) {
      ...
      var s = n(146),
        ...
        u = r,
        f = l(o.a, s.a, !1, u, null, null);
      (f.options.__file = "src/components/Twitter.vue"),
        (t.default = f.exports);
    },
    function (e, t, n) {
      var r = n(145);
            ...
            [
              ...
              n(
                ...
                [
                  e._l(e.defaultColors, function (t, r) {
                    return n("span", {
                      ...
                      style: {
                        background: t,
                        boxShadow:
                          "0 0 4px " + (e.equal(t) ? t : "transparent"),
                      },
                      on: {
                        click: function (n) {
                          return e.handlerClick(t);
                  ...
                  e._v(" "),
                  n("div", { staticClass: "vc-twitter-hash" }, [e._v("#")]),
                  e._v(" "),
                  n("editable-input", {
                    attrs: { label: "#", value: e.hex },
                    on: { change: e.inputChange },
